...
chart_obs = alt.Chart(df_pos_short).mark_line().encode(
...
df_pos2016_active = df_pos_termination[df_pos_termination["PGM_TRMNTN_CD_2016"] == 0]
closed_hospitals = []
closed_hospitals = df_pos2016_active["FAC_NAME"][df_pos2016_active["TRMNTN_YEAR"] > 2016].tolist()
...
df_pos_closed = df_pos_termination.loc[df_pos_termination["TRMNTN_YEAR"].notna()]
