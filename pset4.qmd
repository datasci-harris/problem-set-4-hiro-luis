...
zips_withhospital_centroids["HOSPITAL"] = [x != 0 for x in zips_withhospital_centroids["HOSPITAL_NUM"]]

print(zips_withhospital_centroids)

# Plot a choropleth of directly affected ZIP codes
zips_withhospital_centroids.plot(column = "HOSPITAL", linewidth = 1, edgecolor = "0.8", legend = True, figsize = (10, 10))
plt.axis("off")
...
# Plot the number of hospital in TX on the map
zips_texas_centroids_merge.plot(column = "distance", linewidth = 0.5, edgecolor = "0.8", cmap = "OrRd", legend = True, figsize = (10, 10))
plt.axis("off")
