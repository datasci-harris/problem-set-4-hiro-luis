...
val_count = [val_count_2016, len(df_pos2017_short["PRVDR_NUM"].value_counts()), len(df_pos2018_short["PRVDR_NUM"].value_counts()), len(df_pos2019_short["PRVDR_NUM"].value_counts())]
...
chart_short = alt.Chart(df_pos).mark_line().encode(
